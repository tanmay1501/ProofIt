...
import ButtonObject from "../ButtonForm/ButtonObject";
...
const InputPage = () => {
  ...
  const handleAnalyze = async () => {
    try {
      ...
      formData.append("buttonObj", ButtonObject);
      ...
      localStorage.setItem("suggestion", JSON.stringify(result.suggestion));
      console.log(result);
